package ftn.notificationservice;
...
public class PostgresIntegrationTest {
    ...
    public static PostgreSQLContainer<?> postgreSQLContainer = new PostgreSQLContainer<>("postgres:12.6-alpine")
            .withDatabaseName("devops_notification_db")
            .withUsername("devops_ftn")
            .withPassword("devops_ftn");

    @DynamicPropertySource
    static void registerPgProperties(DynamicPropertyRegistry registry) {
        registry.add("spring.datasource.url", () -> "jdbc:tc:postgresql:12.6:///devops_notification_db");
